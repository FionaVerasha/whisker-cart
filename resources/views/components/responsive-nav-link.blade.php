...
@php
    $classes = ($active ?? false)
        ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-brand text-left text-base font-medium text-brand-dark bg-green-50 focus:outline-none focus:text-brand-dark focus:bg-green-100 focus:border-brand-dark transition duration-150 ease-in-out'
